    ...
    <div className="fp">
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Hayat</span>
      ...
      <div className="fpItem">
        <img
          ...
          className="fpImg"
        />
        <span className="fpName">Trinity Grand</span>
      ...
      <div className="fpItem">
        ...
        <span className="fpCity">Raipur</span>
        <span className="fpPrice">Starting from 1700</span>
        <div className="fpRating">
          <button>8.8</button>
          <span>Excellent</span>
        </div>
